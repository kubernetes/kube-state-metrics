...
Flags:
  ...
  -h, --help                                                       Print Help text
      ...
      --metric-volumeattributesclass-parameters-allowlist string   Comma-separated list of VolumeAttributesClass parameter keys that will be used in the kube_volumeattributesclass_parameters metric. Defaults to "iops,throughput,type,provisioned-iops,provisioned-throughput,skuName,iopsReadWrite,bandwidthMBps"
