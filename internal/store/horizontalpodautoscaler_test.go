	...
	cases := []generateMetricsTestCase{
		{
			...
			Want: metadata + `
				...
				kube_horizontalpodautoscaler_status_condition{condition="AbleToScale",reason="reason",horizontalpodautoscaler="hpa1",namespace="ns1",status="false"} 0
				kube_horizontalpodautoscaler_status_condition{condition="AbleToScale",reason="reason",horizontalpodautoscaler="hpa1",namespace="ns1",status="true"} 1
				kube_horizontalpodautoscaler_status_condition{condition="AbleToScale",reason="reason",horizontalpodautoscaler="hpa1",namespace="ns1",status="unknown"} 0
		...
		},
		{
			...
			Want: metadata + `
				...
				kube_horizontalpodautoscaler_status_condition{condition="AbleToScale",reason="reason",horizontalpodautoscaler="hpa2",namespace="ns1",status="false"} 0
				kube_horizontalpodautoscaler_status_condition{condition="AbleToScale",reason="reason",horizontalpodautoscaler="hpa2",namespace="ns1",status="true"} 1
				kube_horizontalpodautoscaler_status_condition{condition="AbleToScale",reason="reason",horizontalpodautoscaler="hpa2",namespace="ns1",status="unknown"} 0
