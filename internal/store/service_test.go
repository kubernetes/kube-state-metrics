...
func TestServiceStore(t *testing.T) {
	...
	const metadata = `
		...
		# HELP kube_service_spec_ports Service ports. One series for each port
...
`,
		...
		},
		{
			...
			Want: `
				# HELP kube_service_spec_ports Service ports. One series for each port
				# TYPE kube_service_spec_ports gauge
				kube_service_spec_ports{namespace="default",service="test-service10",uid="uid10",port_name="",port_protocol="TCP",port_number="8080",node_port_number=""} 1
			`,
			MetricNames: []string{
		...
		},
		{
			...
			Want: `
				# HELP kube_service_spec_ports Service ports. One series for each port
				# TYPE kube_service_spec_ports gauge
				kube_service_spec_ports{namespace="default",service="test-service11",uid="uid11",port_name="http",port_protocol="TCP",port_number="8080",node_port_number=""} 1
				kube_service_spec_ports{namespace="default",service="test-service11",uid="uid11",port_name="grpc",port_protocol="TCP",port_number="50051",node_port_number=""} 1
				kube_service_spec_ports{namespace="default",service="test-service11",uid="uid11",port_name="irc",port_protocol="UDP",port_number="194",node_port_number=""} 1
			`,
			MetricNames: []string{
				"kube_service_spec_ports",
			},
