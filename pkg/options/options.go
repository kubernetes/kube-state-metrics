...
func (o *Options) AddFlags(cmd *cobra.Command) {
	...
	o.cmd.Flags().StringVar(&o.Config, "config", "", "Path to the kube-state-metrics options config file, which is a YAML file that contains the options to be used by kube-state-metrics. If this flag is set, the values in the yaml file override the command line flags for options.")
