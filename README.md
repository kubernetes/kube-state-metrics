...
the [instructions](./docs/metrics/extend/verticalpodautoscaler-metrics.md#Configuration) are located in the [Vertical Pod Autoscaler Metrics](./docs/metrics/extend/verticalpodautoscaler-metrics.md) documentation.
...
For the full list of arguments available, see the documentation in [docs/cli-arguments.md](./docs/developer/cli-arguments.md)
