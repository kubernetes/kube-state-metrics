...
metric collection at all and instead implement their own, but the Prometheus can
[get heapster itself metrics for alert] (https://github.com/kubernetes/heapster/blob/master/docs/debugging.md#debuging).
