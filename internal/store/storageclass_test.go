...
func TestStorageClassStore(t *testing.T) {
	...
	for i, c := range cases {
		c.Func = generator.ComposeMetricGenFuncs(storageClassMetricFamilies(nil, nil, "annotation", "label"))
		c.Headers = generator.ExtractMetricFamilyHeaders(storageClassMetricFamilies(nil, nil, "annotation", "label"))
