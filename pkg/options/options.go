...
type Options struct {
	...
	LabelsAppend             string          `yaml:"labels_append"`
...
func (o *Options) AddFlags(cmd *cobra.Command) {
	...
	o.cmd.Flags().StringVar(&o.LabelsAppend, "metric-labels-append", "", "Comma-separated list of additional Kubernetes label keys that will be added with their corresponding values to all metrics. By default the metric contains only name and namespace labels. Use of regex is supported (Example: '=regex=meta.example.com/(.*),product').")
