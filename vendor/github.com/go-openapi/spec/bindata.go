...
func jsonschemaDraft04JSON() (*asset, error) {
	...
	info := bindataFileInfo{name: "jsonschema-draft-04.json", size: 4375, mode: os.FileMode(420), modTime: time.Unix(1460872076, 0)}
...
func v2SchemaJSON() (*asset, error) {
	...
	info := bindataFileInfo{name: "v2/schema.json", size: 40248, mode: os.FileMode(420), modTime: time.Unix(1473777784, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
