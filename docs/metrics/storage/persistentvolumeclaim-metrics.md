...
```promql
(time() - kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds{condition="Unused",status="true"}) > 30 * 24 * 3600
```
