...
func persistentVolumeMetricFamilies(allowAnnotationsList, allowLabelsList []string) []generator.FamilyGenerator {
	return []generator.FamilyGenerator{
		createPVClaimRef(),
		createPVAnnotations(allowAnnotationsList),
		createPVLabels(allowLabelsList),
		createPVStatusPhase(),
		createPVInfo(),
		createPVCapacityBytes(),
		createPVCreated(),
	}
}
...
func createPVClaimRef() generator.FamilyGenerator {
...
func createPVAnnotations(allowAnnotationsList []string) generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func createPVLabels(allowLabelsList []string) generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func createPVStatusPhase() generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func createPVInfo() generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
		...
		wrapPersistentVolumeFunc(func(p *v1.PersistentVolume) *metric.Family {
			...
			case p.Spec.PersistentVolumeSource.FC != nil:
				...
				fcTargetWWNs, fcWWIDs = getWWNsAndIDs(p.Spec.PersistentVolumeSource.FC, fcTargetWWNs, fcWWIDs)
...
func createPVCapacityBytes() generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func createPVCreated() generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func getWWNsAndIDs(fc *v1.FCVolumeSource, fcTargetWWNs string, fcWWIDs string) (string, string) {
