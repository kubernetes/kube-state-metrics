...
| kube_persistentvolume_created | Gauge | Unix Creation Timestamp | seconds | `namespace`=&lt;persistentvolume-name&gt; <br> `persistentvolume`=&lt;persistentvolume-name&gt; | EXPERIMENTAL |
