	...
	cases := []struct {
	...
	}{
		{
			...
			want: metadata + `
				...
				kube_cronjob_created{cronjob="ActiveRunningCronJob1",namespace="ns1"} -6.21355968e+10
				kube_cronjob_created{cronjob="SuspendedCronJob1",namespace="ns1"} -6.21355968e+10
