...
func persistentVolumeMetricFamilies(allowAnnotationsList, allowLabelsList []string) []generator.FamilyGenerator {
	return []generator.FamilyGenerator{
		createPVClaimRefFamilyGenerator(),
		createPVAnnotationsFamilyGenerator(allowAnnotationsList),
		createPVLabelsNameFamilyGenerator(allowLabelsList),
		createPVStatusPhaseFamilyGenerator(),
		createPVInfoFamilyGenerator(),
		createPVCapacityBytesFamilyGenerator(),
		createPVCreatedFamilyGenerator(),
	}
}
...
func createPVClaimRefFamilyGenerator() generator.FamilyGenerator {
...
func createPVAnnotationsFamilyGenerator(allowAnnotationsList []string) generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func createPVLabelsNameFamilyGenerator(allowLabelsList []string) generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func createPVStatusPhaseFamilyGenerator() generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func updateFC(fc *v1.FCVolumeSource, fcTargetWWNs string, fcWWIDs string) (string, string) {
	...
	return *generator.NewFamilyGeneratorWithStability(
		...
		wrapPersistentVolumeFunc(func(p *v1.PersistentVolume) *metric.Family {
			...
			case p.Spec.PersistentVolumeSource.FC != nil:
				...
				fcTargetWWNs, fcWWIDs = updateFC(p.Spec.PersistentVolumeSource.FC, fcTargetWWNs, fcWWIDs)
...
func createPVCapacityBytesFamilyGenerator() generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
...
func createPVCreatedFamilyGenerator() generator.FamilyGenerator {
	return *generator.NewFamilyGeneratorWithStability(
