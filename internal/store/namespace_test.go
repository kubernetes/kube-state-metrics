...
`,
	...
	for i, c := range cases {
		c.Func = generator.ComposeMetricGenFuncs(namespaceMetricFamilies(nil, nil, "annotation", "label"))
		c.Headers = generator.ExtractMetricFamilyHeaders(namespaceMetricFamilies(nil, nil, "annotation", "label"))
