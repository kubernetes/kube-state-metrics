	...
	cases := []struct {
	...
	}{
		{
			...
			want: metadata + `
				...
				kube_endpoint_address_not_ready{endpoint="test-endpoint",namespace="default"} 1
				...
				kube_endpoint_labels{endpoint="test-endpoint",label_app="example",namespace="default"} 1
			`,
		},
	}
	for _, c := range cases {
