...
doccheck: generate validate-readme
...
validate-readme: generate-readme
...
generate: build-local generate-readme
...
.PHONY: all build build-local all-push all-container container container-* do-push-* sub-push-* push push-multi-arch test-unit test-rules test-benchmark-compare clean e2e validate-modules shellcheck licensecheck lint lint-fix generate generate-readme validate-readme embedmd
