...
# expanding all elements of an array: [*]
# Returns the array as-is, allowing subsequent path segments to operate on the collection.
[status, parents, "[*]"]                 # returns all elements of status.parents
