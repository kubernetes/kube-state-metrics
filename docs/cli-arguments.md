...
Flags:
  ...
  -h, --help                                       Print Help text
      ...
      --metric-deny-denylist string                Comma-separated list of metrics to override the list of metrics in the deny-list. This list comprises of exact metric names and/or regex patterns.
