...
func TestServiceStore(t *testing.T) {
	...
	const metadata = `
		...
		# HELP kube_service_spec_ports Metric providing details about the ports exposed by services.
...
`,
...

		{
			...
			Want: metadata + `
				...
				kube_service_spec_ports{namespace="default",app_protocol="grpc",name="http",node_number="65000",number="80",protocol="TCP",target="8080",service="test-service9",uid="uid9"} 1
			`,
		},
		{
			Obj: &v1.Service{
