...
`,
	...
	for i, c := range cases {
		c.Func = generator.ComposeMetricGenFuncs(jobMetricFamilies(nil, nil, "annotation", "label"))
		c.Headers = generator.ExtractMetricFamilyHeaders(jobMetricFamilies(nil, nil, "annotation", "label"))
