	...
	cases := []generateMetricsTestCase{
		// Verify phase enumerations.
		{
			...
			Want: `
				...
				# HELP kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds Unix timestamp of last transition of a persistent volume claim condition.
				...
				# TYPE kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds gauge
...
`,
		...
		},
		{
			...
			Want: `
				# HELP kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds Unix timestamp of last transition of a persistent volume claim condition.
				# TYPE kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds gauge
				kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds{condition="Unused",namespace="default",persistentvolumeclaim="unused-pvc",status="true"} 1.6e+09
`,
			MetricNames: []string{"kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds"},
		},
		{
			Obj: &v1.PersistentVolumeClaim{
				ObjectMeta: metav1.ObjectMeta{
			...
			Want: `
				# HELP kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds Unix timestamp of last transition of a persistent volume claim condition.
				# TYPE kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds gauge
				kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds{condition="Unused",namespace="default",persistentvolumeclaim="used-pvc",status="false"} 1.7e+09
`,
			MetricNames: []string{"kube_persistentvolumeclaim_status_condition_last_transition_timestamp_seconds"},
		},
		{
