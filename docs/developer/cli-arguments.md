...
Flags:
  ...
  -h, --help                                                 Print Help text
      ...
      --metric-annotations-prefix string                     Prefix to use for Prometheus label names derived from Kubernetes annotations. Set to an empty string to disable the prefix (Example: '--metric-annotations-prefix=""'). (default "annotation")
      ...
      --metric-labels-prefix string                          Prefix to use for Prometheus label names derived from Kubernetes labels. Set to an empty string to disable the prefix (Example: '--metric-labels-prefix=""'). (default "label")
